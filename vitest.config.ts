...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@contracts/channels/browser':        resolve(__dirname, './packages/contracts/src/channels/browser.channels'),
      '@contracts/channels/conversation-ledger': resolve(__dirname, './packages/contracts/src/channels/conversation-ledger.channels'),
      ...
      '@contracts/types/browser':           resolve(__dirname, './packages/contracts/src/types/browser.types'),
