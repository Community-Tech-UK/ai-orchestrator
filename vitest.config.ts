...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@contracts/schemas/chat':            resolve(__dirname, './packages/contracts/src/schemas/chat.schemas'),
      ...
      '@contracts/schemas/loop':            resolve(__dirname, './packages/contracts/src/schemas/loop.schemas'),
      '@contracts/schemas/campaign':        resolve(__dirname, './packages/contracts/src/schemas/campaign.schemas'),
      '@contracts/channels/automation':     resolve(__dirname, './packages/contracts/src/channels/automation.channels'),
      '@contracts/channels/campaign':       resolve(__dirname, './packages/contracts/src/channels/campaign.channels'),
      ...
      '@contracts/channels/operator':       resolve(__dirname, './packages/contracts/src/channels/operator.channels'),
      '@contracts/channels/chat':           resolve(__dirname, './packages/contracts/src/channels/chat.channels'),
      '@contracts/channels/loop':           resolve(__dirname, './packages/contracts/src/channels/loop.channels'),
