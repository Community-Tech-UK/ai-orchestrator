...
describe('INSTANCE_CHANNELS', () => {
  it('has the correct channel values', () => {
    ...
    expect(INSTANCE_CHANNELS.INSTANCE_COMPACTION_PREVIEW).toBe('instance:compaction-preview');
    expect(INSTANCE_CHANNELS.INSTANCE_COMPACTION_APPLY).toBe('instance:compaction-apply');
