...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** Edit-mode signals and keyboard handling in `input-panel.component.ts`, the edit bar, and the fork-send flow in instance detail; covered by `input-panel-edit-mode.spec.ts`.
