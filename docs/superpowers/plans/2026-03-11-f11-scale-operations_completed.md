...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** ResourceGovernor, HibernationManager, PoolManager and LoadBalancer all exist and are started from `late-runtime-initialization-steps.ts`; load-balancer metrics are fed from `instance-event-forwarding.ts`.
