...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** Tool-result dedup (`seenToolResultIds`), `session-mutex.ts`, `fallback-history.ts` wired into resume-failure paths, `stuck-process-detector.ts` wired into InstanceManager, hard/soft rewind checkpoints.
