...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** Runtime event envelope and Zod union, `events$`, lifecycle helpers and adapter descriptors. Task 24 (fixture replay) was delivered by Fable WS1 at the shared adapter-event boundary.
