...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** Shared service foundations plus WinSW, systemd and launchd managers under `src/worker-agent/service/`, and `service-cli.ts`.
