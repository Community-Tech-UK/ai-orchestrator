...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** E1, E4, E5, E6 and E7 are live. E2 feature gates (`ea1087c8`) and E3 compiled permission matchers (`fcc2e22c`) were built and later removed as unused in the `9a204d7a` dead-code audit; that removal is deliberate.
