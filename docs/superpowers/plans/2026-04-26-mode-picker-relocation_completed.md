...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** Launch row removed from the sidebar header, controlled `AgentSelectorComponent`, mode pill in the draft composer, `agentId` through `welcome-coordinator.service.ts` to the create payload.
