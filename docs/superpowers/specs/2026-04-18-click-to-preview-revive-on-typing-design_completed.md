...
> **Reconciled 2026-09-23 (outstanding-plans sweep, [plan](../../plans/2026-09-23-outstanding-plans-sweep_plan_completed.md)): COMPLETE.** Implemented under other names: `onPreviewHistory` (instance list), `ensureHistoryPreviewRestored` on first keystroke, `HistoryPreviewSessionService`, and wake-on-send for hibernated instances.
