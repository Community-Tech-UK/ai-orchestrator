...
const exactAliases: Record<string, string> = {
  ...
  '@contracts/schemas/copilot-account':          path.join(baseContracts, 'schemas', 'copilot-account.schemas'),
  '@contracts/schemas/provider-account':         path.join(baseContracts, 'schemas', 'provider-account.schemas'),
  ...
  '@contracts/schemas/browser-unattended':       path.join(baseContracts, 'schemas', 'browser-unattended.schemas'),
  ...
  '@contracts/schemas/loop-events':              path.join(baseContracts, 'schemas', 'loop-events.schemas'),
  '@contracts/schemas/campaign':                 path.join(baseContracts, 'schemas', 'campaign.schemas'),
  '@contracts/schemas/plan-queue':               path.join(baseContracts, 'schemas', 'plan-queue.schemas'),
  '@contracts/schemas/doc-review':               path.join(baseContracts, 'schemas', 'doc-review.schemas'),
  '@contracts/schemas/rlm-maintenance':          path.join(baseContracts, 'schemas', 'rlm-maintenance.schemas'),
  '@contracts/schemas/rtk':                      path.join(baseContracts, 'schemas', 'rtk.schemas'),
  '@contracts/schemas/context-evidence':         path.join(baseContracts, 'schemas', 'context-evidence.schemas'),
  '@contracts/schemas/workboard':                path.join(baseContracts, 'schemas', 'workboard.schemas'),
  '@contracts/channels/automation':              path.join(baseContracts, 'channels', 'automation.channels'),
  '@contracts/channels/campaign':                path.join(baseContracts, 'channels', 'campaign.channels'),
  ...
  '@contracts/types/instance-events':            path.join(baseContracts, 'types', 'instance-events'),
  '@contracts/types/provider-runtime-events':    path.join(baseContracts, 'types', 'provider-runtime-events'),
