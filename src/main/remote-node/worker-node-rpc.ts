...
export const COORDINATOR_TO_NODE = {
  ...
  LOCAL_MODEL_SESSION_START: 'localModel.session.start',
  LOCAL_MODEL_SESSION_SEND_INPUT: 'localModel.session.sendInput',
  LOCAL_MODEL_SESSION_TERMINATE: 'localModel.session.terminate',
  LOCAL_MODEL_SESSION_INTERRUPT: 'localModel.session.interrupt',
