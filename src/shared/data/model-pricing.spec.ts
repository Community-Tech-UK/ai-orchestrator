...
describe('computeTokenCost', () => {
  ...
  it('does not keep a static rate for removed Claude Fable 5', () => {
    expect(hasModelRate('claude-fable-5')).toBe(false);
    expect(getModelRate('claude-fable-5')).toEqual(DEFAULT_MODEL_RATE);
  });
});
