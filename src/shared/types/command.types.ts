...
export const BUILT_IN_COMMANDS: Omit<CommandTemplate, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  {
    name: 'doctor',
    description: 'Open diagnostics and CLI health',
    template: '',
    hint: 'Open Doctor diagnostics',
  ...
  {
    name: 'browser',
    description: 'Open Browser Gateway',
    template: '',
    hint: 'Open managed browser profiles',
    aliases: ['browser-gateway'],
    category: 'navigation',
    usage: '/browser',
    examples: ['/browser'],
