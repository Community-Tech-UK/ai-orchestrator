...
export const COPILOT_MODELS = {
  ...
  GPT6_ASTRA: OPENAI_MODELS.GPT6_ASTRA,
  GPT56_SOL: OPENAI_MODELS.GPT56_SOL,
  GPT56_TERRA: OPENAI_MODELS.GPT56_TERRA,
  GPT56_LUNA: OPENAI_MODELS.GPT56_LUNA,
  GPT55: 'gpt-5.5',
  GPT54: 'gpt-5.4',
  GPT53_CODEX: 'gpt-5.3-codex',
  ...
  GPT41: 'gpt-4.1',
  GEMINI_37_FLASH: GOOGLE_MODELS.GEMINI_37_FLASH,
  GEMINI_36_FLASH: GOOGLE_MODELS.GEMINI_36_FLASH,
  ...
  MAI_CODE_11_FLASH: 'mai-code-1.1-flash',
...
export const PROVIDER_MODEL_LIST: Record<string, ModelDisplayInfo[]> = {
  ...
  copilot: [
    ...
    // must be pinned to satisfy the pinned-default invariant. Membership tracks
    // Copilot CLI 1.0.83 `help config` plus ids the CLI serves but does not
    // advertise (`auto`, `gpt-6-astra`). Live discovery unions that roster with
    // this list so a newer CLI still surfaces these omissions.
    { id: COPILOT_MODELS.GEMINI_3_1_PRO, name: 'Gemini 3.1 Pro (Preview)', tier: 'powerful', pinned: true, family: 'Gemini' },
    { id: COPILOT_MODELS.GPT6_ASTRA, name: 'GPT-6 Astra', tier: 'powerful', pinned: true, family: 'GPT' },
    { id: COPILOT_MODELS.CLAUDE_OPUS_5, name: 'Claude Opus 5', tier: 'powerful', pinned: true, family: 'Claude' },
    { id: COPILOT_MODELS.GPT56_SOL, name: 'GPT-5.6 Sol', tier: 'powerful', pinned: true, family: 'GPT' },
    { id: COPILOT_MODELS.AUTO, name: 'Auto', tier: 'balanced', pinned: true, family: 'Auto' },
    { id: COPILOT_MODELS.CLAUDE_SONNET_5, name: 'Claude Sonnet 5', tier: 'balanced', family: 'Claude' },
    { id: COPILOT_MODELS.CLAUDE_OPUS_48, name: 'Claude Opus 4.8', tier: 'powerful', family: 'Claude' },
    { id: COPILOT_MODELS.CLAUDE_OPUS_48_FAST, name: 'Claude Opus 4.8 Fast', tier: 'powerful', family: 'Claude' },
    { id: COPILOT_MODELS.CLAUDE_OPUS_47, name: 'Claude Opus 4.7', tier: 'powerful', family: 'Claude' },
    { id: COPILOT_MODELS.CLAUDE_SONNET_46, name: 'Claude Sonnet 4.6', tier: 'balanced', family: 'Claude' },
    ...
    { id: COPILOT_MODELS.GPT56_TERRA, name: 'GPT-5.6 Terra', tier: 'balanced', family: 'GPT' },
    { id: COPILOT_MODELS.GPT56_LUNA, name: 'GPT-5.6 Luna', tier: 'fast', family: 'GPT' },
    { id: COPILOT_MODELS.GPT55, name: 'GPT-5.5', tier: 'balanced', family: 'GPT' },
    ...
    { id: COPILOT_MODELS.MAI_CODE_11_FLASH, name: 'MAI Code 1.1 Flash', tier: 'fast', family: 'GitHub' },
    { id: COPILOT_MODELS.MAI_CODE_1_FLASH_PICKER, name: 'MAI Code 1 Flash', tier: 'fast', family: 'GitHub' },
    { id: COPILOT_MODELS.GEMINI_37_FLASH, name: 'Gemini 3.7 Flash', tier: 'fast', family: 'Gemini' },
    { id: COPILOT_MODELS.GEMINI_36_FLASH, name: 'Gemini 3.6 Flash', tier: 'fast', family: 'Gemini' },
    { id: COPILOT_MODELS.GEMINI_35_FLASH, name: 'Gemini 3.5 Flash', tier: 'fast', family: 'Gemini' },
    { id: COPILOT_MODELS.KIMI_K3, name: 'Kimi K3', tier: 'balanced', family: 'Kimi' },
    { id: COPILOT_MODELS.KIMI_K27_CODE, name: 'Kimi K2.7 Code', tier: 'balanced', family: 'Kimi' },
  ],
  ollama: [],
