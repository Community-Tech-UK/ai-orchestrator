...
describe('API Features Types', () => {
  describe('supportsPromptCaching', () => {
    ...
    it('should return false for unsupported models', () => {
      ...
      expect(supportsPromptCaching('claude-fable-5')).toBe(false);
    });
  });
  ...
  describe('type definitions', () => {
    ...
    it('should have PROMPT_CACHING_MODELS array', () => {
      ...
      expect(PROMPT_CACHING_MODELS).not.toContain('claude-fable-5');
      expect(MIN_CACHEABLE_TOKENS['claude-opus-4-8']).toBe(1024);
      expect(MIN_CACHEABLE_TOKENS['claude-fable-5']).toBeUndefined();
    });
