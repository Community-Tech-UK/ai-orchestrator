...
// Re-export types from contracts (Phase 1 migration shim)
export type { IpcMessage } from '@contracts/types';

// Re-export all payload types so existing imports continue to compile
export type {
  ...
  InstanceRestartFreshPayload,
  InstanceRenamePayload,
  TokenRequestPayload,
  TokenResponsePayload,
  CrossInstanceMessagePayload,
  ControlInstancePayload,
  SubscribePayload,
  CreateBridgePayload,
  SupervisorMetrics,
  SupervisorNodeMetrics,
  ErrorInfo,
  SettingsSetPayload,
  ...
  InstructionsResolvePayload,
  InstructionsCreateDraftPayload,
  ...
  TaskCancelPayload,
  TaskGetPreflightPayload,
  RepoJobSubmitPayload,
  RepoJobListPayload,
  RepoJobGetPayload,
  RepoJobCancelPayload,
  RepoJobRerunPayload,
  ...
  SecuritySetPermissionPresetPayload,
  ...
  StatsExportPayload,
  InstanceCompactPayload,
  InstanceCompactResultPayload,
  ...
  EcosystemListPayload,
  EcosystemWatchStartPayload,
  EcosystemWatchStopPayload,
  HooksListPayload,
  HooksGetPayload,
  HooksCreatePayload,
  HooksUpdatePayload,
