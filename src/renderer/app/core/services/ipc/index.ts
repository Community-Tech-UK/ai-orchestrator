...
export { RtkIpcService, type RtkStatusData, type RtkSavingsSummary, type RtkCommandStat, type RtkCommandRecord } from './rtk-ipc.service';
...
export class IpcFacadeService {
  ...
  wakeInstance = this.instance.wakeInstance.bind(this.instance);
  ...
  listWorkspaceSecrets = this.instance.listWorkspaceSecrets.bind(this.instance);
  forgetWorkspaceSecret = this.instance.forgetWorkspaceSecret.bind(this.instance);
  getWorkspaceSecretAudit = this.instance.getWorkspaceSecretAudit.bind(this.instance);
  ...
  updateCli = this.provider.updateCli.bind(this.provider);
  updateAllClis = this.provider.updateAllClis.bind(this.provider);
