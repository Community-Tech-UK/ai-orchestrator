...
export const DEFAULT_COPILOT_MODELS: CopilotModel[] = [
  ...
  { id: COPILOT_MODELS.CLAUDE_OPUS_45, name: 'Claude Opus 4.5', tier: 'flagship', supportsVision: true, contextWindow: 200000 },
  { id: COPILOT_MODELS.CLAUDE_SONNET_46, name: 'Claude Sonnet 4.6', tier: 'high', supportsVision: true, contextWindow: 1000000 },
